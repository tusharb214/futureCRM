@import
url("https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap");

:root {
--primary-lite-color: #808085;
--primary-dark-color: rgb(22 45 145 / 50%);
...
/*sidenavbarcontent active*/
/*sidenavbar financial operation*/
.pcoded
.pcoded-navbar[navbar-theme="theme1"]
.pcoded-item
> li.pcoded-trigger
...
.current-page-mt4 .page-link:hover,
...
.page-item-mt4.active .page-link-mt4,
.page-item.active .page-link {
background-color: #303a92 !important;
border-color: #303a92 !important;
}
.previous-page-mt4:hover a,
...
.next-page-mt4 a,
.next-page-mt4:active a .previous-page-mt4:active a,
.pervious-page-mt4:focus a,
.previous-page-mt4 a,
.next-page a,
.next-page:active a .previous-page:active a,
.pervious-page:focus a,
.previous-page a {
outline: none;
border: none;
...
.next-page-mt4 .page-link-mt4:hover,
...
.blue-text {
color: #042e5b !important;
}
.green-text {
color: #07a76f !important;
}
...
border: 1px solid #0bbb66 !important;
outline: none !important;
color: #303a92;
}
.head-register:hover,
.head-register:focus,
.head-register:active {
background-color: #fff !important;
...
> li:hover
> a:before {
border-left-color: #0bbb66 !important;
}
.pcoded
.pcoded-navbar[navbar-theme="theme1"]
.pcoded-item
...
.acc-select-btn .btn-warning:hover {
background-color: #fff;
color: black;
}
.card-account ul {
...
.profile-card-head {
border-bottom: 1px solid rgb(180, 171, 171);
}
.profile-card-body h5 {
border-bottom: 1px solid rgb(180, 171, 171);
}

.profile-card-body h5:hover {
...
height: 85px;
background-color: #fff;
box-shadow: 0 1px 2.94px 0.06px rgb(190 23 23 / 49%);
}
.rules-bonus a {
color: #303a92 !important;
}
...
.reg-footer footer .footer-content {
...
.ftco-animate .fab, .ftco-animate .fas {
font-size: 21px;
}
.footer-07 p {
color: #0bbb66;
...
.footer-07 .footer-heading a:hover{
color:#fff !implement;
...
.show > .dropdown-menu {
transform: translate3d(-165px, 45px, 0px) !important;
...
background: linear-gradient(60deg, #073d8b, #30ffa0);
border-radius: 50%;
width: 30px;
height: 30px;
}
.fund-manager-content p {
line-height: 28px;
font-size: 15px;
}
.carousal-desc {
...
.pcoded .pcoded-navbar[navbar-theme="theme1"] .pcoded-item > li.active > a {
background-color: #0bbb66 !important;
}
.pcoded[theme-layout="vertical"] .pcoded-navbar .pcoded-item > li:hover {
color: #fff;
}
...
.monit-col:active .monit-col {
background: black;
color: #fff;
}

#monit-dropdown .btn-secondary {
color: black;
background-color: transparent;
color: black;
...
/*partner room*/
@media (max-width: 950px) and (max-width: 1200px) {
.carousal-img img {
width: 175px;
height: 170px;
display: flex;
...
border-radius: 50%;
border: 3px solid transparent;
border-left-color: #0bbb66;
border-right-color: #0bbb66;
-webkit-animation: round-rotate 1.5s ease-in-out infinite;
animation: round-rotate 1.5s ease-in-out infinite;
}
...
background: linear-gradient(to right, #000, #303a92);
}
...
.transact-card .dropdown .btn:focus {
outline: 0;
box-shadow: none;
}
.header-navbar
...
.profile-notification
li {
border-top: 1px solid #01a9ac, #fe9365, #e0e0e0, #fe5d70, #000, #404e67,
#2dcee3;
line-height: initial;
padding: 1em 20px;
width: 100%;
...
.navbar-container
.header-notification
.show-notification.notification-view
li:first-child:hover,
.header-navbar
.navbar-wrapper
.navbar-container
.header-notification
.notification-view.profile-notification
li:first-child:hover {
background-color: transparent;
}
...
.pcoded[vertical-nav-type="collapsed"][vertical-placement="right"]
.pcoded-search.open
.pcoded-search-box {
margin-left: 0;
margin-right: 70px;
...
li
> a:before {
border-left-color: #303a92 !important;
}
...
background-color: #fff;
color: #303a92;
border: 1px solid #303a92 !important;
}
.btn-warning:hover,
.btn-name-color {
color: #303a92 !important;
...
.btn-success {
/* background-image: linear-gradient(to right, #303a92, #2fa373); */
border: 1px solid #0bbb66;
color: #fff;
cursor: pointer;
-webkit-transition: all ease-in 0.3s;
...
.z-depth-top-1 {
-webkit-box-shadow: 0 -7px 25px -5px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-top-2 {
-webkit-box-shadow: 0 -9px 25px -5px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-top-3 {
-webkit-box-shadow: 0 -10px 25px -5px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-top-4 {
-webkit-box-shadow: 0 -11px 25px -5px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-top-5 {
-webkit-box-shadow: 0 -12px 25px -5px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-left-0 {
-webkit-box-shadow: -5px 0 25px -5px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-left-1 {
-webkit-box-shadow: -7px 0 25px -5px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-left-2 {
-webkit-box-shadow: -9px 0 25px -5px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-left-3 {
-webkit-box-shadow: -10px 0 25px -5px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-left-4 {
-webkit-box-shadow: -11px 0 25px -5px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-left-5 {
-webkit-box-shadow: -12px 0 25px -5px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-0 {
-webkit-box-shadow: 0 0 25px 5px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-1 {
-webkit-box-shadow: 0 0 25px 7px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-2 {
-webkit-box-shadow: 0 0 25px 9px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-3 {
-webkit-box-shadow: 0 0 25px 10px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-4 {
-webkit-box-shadow: 0 0 25px 11px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.z-depth-5 {
-webkit-box-shadow: 0 0 25px 12px #ccc, 0 1px 5px 0 rgba(0, 0, 0, 0.1),
0 0 0 0 transparent;
...
.pass-field {
border-right-color: #e8f0fe !important;
}
.wallet-head h4 {
/* padding-top: 0px; */
...
.info-nav .navbar-varient-submenu,
.danger-nav .navbar-varient-submenu {
-webkit-box-shadow: -2 0 1px 2px rgba(0, 0, 0, 0.03),
0 -2px 1px -2px rgba(0, 0, 0, 0.02), 0 0 0 -1px rgba(0, 0, 0, 0.03);
...
.pcoded[layout-type="dark"]
.footable-details.table-striped
> tbody
> tr:nth-child(odd),
...
.header-notification ul.show-notification {
padding-left: 0px;
}

.header-notification ul.show-notification li {
padding: 8px !important;
}
.header-notification ul.show-notification li a {
width: 100%;
}
...
#acc-dropdown .dropdown-item:hover {
background: #b2bbc6;
color: #3e5571;
}
#acc-dropdown .dropdown-item .verify-check .fas {
font-size: 12px !important;
}
.h-80 {
height: 80%;
}
.account-card .dropdown-menu li {
padding: 6px 10px;
background: #b2bbc68a;
}
.account-card .dropdown-menu li a {
color: #3e5571;
}
.account-card .dropdown-menu li:hover {
color: #fff;
background: #000000a1;
}
.account-card .dropdown-menu li:hover a {
color: #fff;
}